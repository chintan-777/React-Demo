...
function Feed() {
    ...
    const userlist = users.map( (user) => {
        return <User key={user.id} name={`${user.name.firstname} ${user.name.lastname}`} email={user.email} phone={user.phone}/>
    })

    return (
        <div className="feed_container">
            <h2> People <span>153</span></h2>
            <div className="feedHeader">
                ...
                <div className="buttons">
                    <buttons className="button1"> 
                        {/* <AccessTimeOutlinedIcon className="time" />  */}
                        Register Time Away
                    </buttons>
                    <buttons className="button2">Add a new Employee</buttons>
                </div>
            </div>
            <div className="searchbar">
                <div className="searchbar_start">
                    <div className="input">
                        <input placeholder="search by name, email, team etc" />
                        {/* <SearchOutlinedIcon className="searchicon"/> */}
                    </div>
                    <div className="input">
                        <input placeholder="Position" />
                        {/* <KeyboardArrowDownOutlinedIcon className="drop" /> */}
                    </div>
                </div>
                <div className="searchbar_end">
                        <p>Sort By: Date</p>
